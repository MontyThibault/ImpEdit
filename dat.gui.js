...
/***/ function(module, exports, __webpack_require__) {
	...
	function logmap(v, i1, i2, o1, o2) {
	  return Math.exp(map(v, i1, i2, Math.log(o1), Math.log(o2)));
	}
	...
	var NumberControllerSlider = function (_NumberController) {
	  ...
	  function NumberControllerSlider(object, property, min, max, step) {
	    ...
	    function onMouseDrag(e) {
	      ...
	      if (_this.log) {
	        _this.setValue(logmap(e.clientX, bgRect.left, bgRect.right, _this.__min, _this.__max));
	      } else {
	  ...
	  NumberControllerSlider.prototype.updateDisplay = function updateDisplay() {
	    ...
	    if (this.log) {
	      pct = (Math.log(this.getValue()) - Math.log(this.__min)) / (Math.log(this.__max) - Math.log(this.__min));
	    } else {
	      pct = (this.getValue() - this.__min) / (this.__max - this.__min);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function augmentController(gui, li, controller) {
	  ...
	  if (controller instanceof _NumberControllerSlider2.default) {
	    ...
	    _common2.default.each(['updateDisplay', 'onChange', 'onFinishChange', 'step', 'setValue'], function (method) {
